		...
		<div class="container">						
			<section class="section section--menu" id="Prospero">
				...
				<nav class="menu menu--prospero">
					<ul class="menu__list">
						<li class="menu__item menu__item--current"><a href="#" class="menu__link">All</a></li>
						<li class="menu__item"><a href="#" class="menu__link">CODY</a></li>
						<li class="menu__item"><a href="#" class="menu__link">PERFUME</a></li>									
					</ul>
				</nav>
				<div class="btn_group">
					<button class="btn_1" >좋아요순</button>
					<button class="btn_2">최신순</button>
				</div>				
			</section>		
