...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css_04_03/content.css" />
    <title>헤더</title>
		<link rel="stylesheet" href="css_04_03/style_h.css">
...
<body>
    <div class="header">
        <div class="container_h">
            <div class="navbar">
                <div class="logo">
                    <a href="index.html"><img src="images_04_03/logo.png" width="125px"></a>
                </div>
                <nav class="nav_h">
                    <ul class="ul_h">
